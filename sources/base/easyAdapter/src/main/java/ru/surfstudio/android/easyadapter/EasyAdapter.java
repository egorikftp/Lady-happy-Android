...
public class EasyAdapter extends RecyclerView.Adapter {
    ...
    public <T> void setData(@NonNull Collection<T> data, @NonNull BindableItemController<T, ? extends RecyclerView.ViewHolder> itemController) {
        setItems(ru.surfstudio.android.easyadapter.ItemList.create(data, itemController));
    }
     ...
     */
    protected void setItems(@NonNull ru.surfstudio.android.easyadapter.ItemList items, boolean autoNotify) {
        this.items.clear();
    ...
    protected ru.surfstudio.android.easyadapter.ItemList getItems() {
        return new ru.surfstudio.android.easyadapter.ItemList(items);
    }
     ...
     * @param items
     */
    public void setItems(@NonNull ru.surfstudio.android.easyadapter.ItemList items) {
