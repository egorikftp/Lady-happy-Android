...
sealed class ChooserType {
    ...
    data class Category(
        ...
        @StringRes
        override val hintResId: Int = R.string.post_creator_chooser_hint_categories,
    ...
    data class SubCategory(
        override val title: String = EMPTY,
        @StringRes
        override val hintResId: Int = R.string.post_creator_chooser_hint_subcategories,
        override val state: ChooserState,
    ...
    data class Color(
        override val title: String = EMPTY,
        @StringRes
        override val hintResId: Int = R.string.post_creator_chooser_hint_color,
        override val state: ChooserState,
    ...
    data class CreationDate(
        override val title: String = EMPTY,
        @StringRes
        override val hintResId: Int = R.string.post_creator_chooser_hint_creation_date,
        override val state: ChooserState,
        val date: Date? = null,
    ) : ChooserType()
}
