package com.egoriku.ladyhappy.postcreator.presentation.dialog.color
...
import com.egoriku.ladyhappy.postcreator.presentation.dialog.color.adapter.ColorAdapter
import com.egoriku.ladyhappy.postcreator.presentation.dialog.color.adapter.MyItemDetailsLookup
...
class ColorDialog : BaseDialogFragment() {
    ...
    override val dialogTitleResId: Int = R.string.post_creator_color_dialog_title
