    ...
    private fun render(screenModel: LandingScreenModel) {
        ...
        screenModel.landingModel?.let {
            itemList.add(headerController)
                    ...
                    .addIf(it.quotes.isNotEmpty(), R.string.landing_adapter_item_header_quotes, sectionsHeaderController)
                    .addIf(it.quotes.isNotEmpty(), it.quotes, quotesController)
                    .addIf(it.teamMembers.isNotEmpty(), R.string.landing_adapter_item_header_our_team, sectionsHeaderController)
